                      ...
                      <ul>
                        ...
                        <li>
                          <a
                            ...
                            className="d-flex justify-content-between align-items-center"
                          >
                            <span className="courses-name">HTML Images</span>
                            <div className="courses-meta">
                        ...
                        <li>
                          <a
                            ...
                            className="d-flex justify-content-between align-items-center"
                          >
                            <span className="courses-name">HTML Basics</span>
                            <div className="courses-meta">
                      ...
                      <ul>
                        ...
                        <li>
                          <a
                            ...
                            className="d-flex justify-content-between align-items-center"
                          >
                            <span className="courses-name">HTML5 Features</span>
                            <div className="courses-meta">
                        ...
                        <li>
                          <a
                            ...
                            className="d-flex justify-content-between align-items-center"
                          >
                            <span className="courses-name">HTML5 Graphics</span>
                            <div className="courses-meta">
                              <span className="duration">15 Min</span>
                              <span className="status locked">
                                {/* <i className="flaticon-password"></i> */}
