                        ...
                        <li>
                          ...
                          >
                            ...
                            <div className="courses-meta">
                              ...
                              <span className="duration">06 Min</span>
                              <span className="status">Preview</span>
                            </div>
                          </a>
                        </li>
                      </ul>
                      <h3>CSS Inclusion In HTML</h3>
                      <ul>
                        <li>
                          <a
                            href="#"
                          ...
                          >
                            ...
                            <div className="courses-meta">
                              <span className="duration">03 Min</span>
                        ...
                        <li>
                          <a
                            ...
                            className="d-flex justify-content-between align-items-center"
                          >
                            <span className="courses-name">CSS Links</span>
                            <div className="courses-meta">
                              <span className="duration">03 Min</span>
                              <span className="status locked">
                                {/* <i className="flaticon-password"></i> */}
                        ...
                        <li>
                          ...
                          >
                            <span className="courses-name">CSS Links</span>
                            <div className="courses-meta">
                              <span className="duration">05 Min</span>
                              <span className="status locked">
                                {/* <i className="flaticon-password"></i> */}
                              </span>
                            </div>
                        ...
                        <li>
                          <a
                            ...
                            className="d-flex justify-content-between align-items-center"
                          >
                            <span className="courses-name">CSS Text</span>
                            <div className="courses-meta">
                        ...
                        <li>
                          <a
                            ...
                            className="d-flex justify-content-between align-items-center"
                          >
                            <span className="courses-name">CSS Colors</span>
                            <div className="courses-meta">
...
//         homePageUrl="/"
//         homePageText="Home"
//         innerPageUrl="/courses-2"
//         innerPageText="Courses"
//         activePageText="HTML-5"
//       />
